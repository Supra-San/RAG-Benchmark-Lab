...
![RAG Benchmark Lab Banner](./Pic1.webp)
...
Written to accompany a series of articles on [Medium](https://suprapto-santoso.medium.com) — link to each lab's article is in the table below.

## Series Roadmap

| Lab | Topic | Status | Article | Code |
|---|---|---|---|---|
| 01 | Document Parsing (PyMuPDF vs Docling vs LlamaParse vs Landing.AI DPT) | Published | [Read on Medium](https://suprapto-santoso.medium.com/battle-of-document-parsing-rag-pymupdf-vs-docling-vs-llamaparse-vs-dpt-8d26a2d0175f) | [`01-Dokumen-parsing/`](./01-Dokumen-parsing) |
...
`https://colab.research.google.com/github/Supra-San/RAG-Benchmark-Lab/blob/main/01-Dokumen-parsing/Document_Parsing.ipynb`

**Option B — Local Jupyter**
```bash
git clone https://github.com/Supra-San/RAG-Benchmark-Lab.git
cd RAG-Benchmark-Lab/01-Dokumen-parsing
# Buka dan jalankan sel instalasi di dalam notebook
jupyter notebook
```
...
- **Read the articles:** [Medium](https://suprapto-santoso.medium.com)
- **Connect:** [LinkedIn](https://www.linkedin.com/in/suprapto-santoso/)
...
**Suprapto Santoso**
*AI & IoT Developer*
Focused on Generative AI, Embedded Systems, and Smart Automation
Email: [supraptosantoso.san@gmail.com](mailto:supraptosantoso.san@gmail.com) | [LinkedIn](https://www.linkedin.com/in/suprapto-santoso/) | [Medium](https://suprapto-santoso.medium.com)
